...
<template>
    <div class="bg-[#181818]" v-cloak>
        ...
        <section class="container relative flex justify-between pb-14 2xl:pb-32" id="hero">
            ...
            <div ref="leftCol" class="z-50 w-full 2xl:w-[830px]">
                <h1
                    class="mb-5 text-center text-[24px] font-bold !leading-tight sm:max-w-[335px] sm:text-left md:max-w-[425px] md:text-3xl 2xl:mb-12 2xl:max-w-none 2xl:text-6xl">
                ...
                <div class="mb-7 mt-[320px] flex flex-col sm:mb-12 sm:mt-0 2xl:mb-28 2xl:flex-row">
                ...
                <div
                    ...
                    <div
                        ...
                        :key="num"
                        :class="[
                            'relative w-min pl-6 text-sm !leading-tight before:absolute before:left-0 before:text-[40px] before:font-bold before:leading-none sm:w-28 sm:pl-8 sm:text-base md:text-lg sm:before:text-5xl md:before:text-[51px] 2xl:w-40 2xl:pl-12 2xl:text-2xl 2xl:before:text-7xl',
                            `before_content_${num}`,
                        ]">
                        {{ value }}
                    </div>
            ...
            <div
                class="absolute left-1/2 top-[28%] h-[280px] w-[280px] -translate-x-1/2 duration-1000 sm:left-[60%] sm:top-[10%] sm:translate-x-[none] 2xl:relative 2xl:top-0 2xl:left-0 2xl:h-auto 2xl:w-auto">
                <TheStardust
    ...
    <section class="container py-12 2xl:py-20">
        <ul
            ref="offersRef"
            class="flex list-disc flex-wrap justify-around gap-4 pl-4 text-lg font-medium 2xl:ml-10 2xl:text-5xl [&>li]:duration-500">
            <li v-for="offer in ourOffer" :key="offer.title" class="opacity-0">
                {{ offer.title }}
                <p class="whitespace-nowrap text-xs font-normal 2xl:text-3xl">{{ offer.subTitle }}</p>
            </li>
        </ul>
    </section>
</template>

...
<path ref="path" d="M328.906 201.117C302.84 269.741 210.304 298.872 121.719 265.224C33.1337 231.576 -16.7279 148.357 9.33821 79.7332C35.4043 11.1091 127.94 -18.0211 216.525 15.627C305.11 49.2751 354.972 132.493 328.906 201.117Z" stroke="#1495FE"
            stroke-opacity="0.6" stroke-width="3" pathLength="1"/>
</svg>
</template>
